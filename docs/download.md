...
Total: **45.0 GB of images (2,751 files), plus 9.30 GB of laser scans (241 files).**
...
- You can download **one capture group** instead of all 45.0 GB.
...
- No 45 GB of scratch space needed just to unpack an archive.
...
# sample pack (~650 MB) — look before you commit to 55.0 GB
...
```bash
./scripts/download.sh --laser        # 241 files, 9.30 GB
```
